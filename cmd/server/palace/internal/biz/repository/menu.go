...
type Menu interface {
	// Create 创建系统菜单
	Create(ctx context.Context, user *bo.CreateMenuParams) (*model.SysMenu, error)
	// UpdateById 更新系统菜单
	UpdateById(ctx context.Context, user *bo.UpdateMenuParams) error
	// DeleteById 删除系统菜单
	DeleteById(ctx context.Context, id int64) error
	// GetById 根据id获取系统菜单
	GetById(ctx context.Context, id int64) (*model.SysMenu, error)
	// FindByPage 分页查询系统菜单
	...
	UpdateTypeByIds(ctx context.Context, status vobj.MenuType, ids ...uint32) error
}
